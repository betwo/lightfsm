...
protected:
    nav_msgs::OccupancyGridPtr generateSearchSpace(const cv::Point2i& map_pos, double min_move_distance,
                                                   double min_distance_to_obstacles, double max_distance_to_unknown);
